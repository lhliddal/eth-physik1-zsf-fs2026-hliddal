...
\formulanote{Zweck: Berechnung des Widerstands aus Geometrie ($\ell, A$) und Material ($\rho$).}
\end{formulabox}
...
\formulanote{Zweck: Lokales Ohm'sches Gesetz (Zusammenhang zwischen E-Feld und Stromdichte).}
\end{formulabox}
\begin{runintext}
