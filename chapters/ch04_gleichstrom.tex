...
\end{longformula}
\formulanote{Zweck: Definition Strom in $[A] = [C/s]$ (Ladungsfluss pro Zeit) \& Teilchenrate.}
\formulasep
...
\formulanote{Zweck: Stromdichte aus Strom/Fläche.}
\end{formulabox}
\begin{runintext}
$N$: Anzahl Teilchen (z.\,B.\ Elektronen), $e$: \ZSFkeyword{Elementarladung}, $n/V$: \ZSFkeyword{Ladungsträgerdichte} (Teilchen/Volumen), $A$: Querschnitt, $v_{\mathrm{d}}$: \ZSFkeyword{Driftgeschwindigkeit}. $I$ = Fluss von $\vec{\jmath}$ durch Fläche.
\end{runintext}
...
\formulanote{Zweck: Ohm'sches Gesetz; Widerstand aus Geometrie/Material; Temperaturabhängigkeit; lokales Ohm'sches Gesetz.}
\end{formulabox}
\begin{runintext}
