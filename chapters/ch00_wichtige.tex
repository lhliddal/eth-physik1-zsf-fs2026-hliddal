...
\StartChapterOnNewColumn{Wichtige Formeln}
...
\end{cases}
\]
\formulanote{Zweck: E-Feld \& Potenzial einer geladenen Kugelschale.}
\end{formulabox}
...
\end{runintext}
\begin{formulabox}
\textbf{1. Substitution:} ($h$ = Lotabstand, $\vartheta$ = Winkel relativ zum Lot)
\[ \begin{aligned}
...
\end{aligned} \]
\formulasep
\textbf{2. Elektrisches Feld ($\vec{E}$) einer Linienladung $\lambda$:}
\[ \begin{aligned}
...
\end{aligned} \]
\formulasep
\textbf{3. Magnetfeld ($\vec{B}$) eines geraden Stromleiters $I$:}
\[
...
\formulanote{Zweck: Umrechnung Frequenz/Kreisfrequenz; Blindwiderstände; LC-Eigenfrequenz; Transformator-Übersetzung.}
\end{formulabox}
