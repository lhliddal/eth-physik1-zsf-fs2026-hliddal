...
\begin{runintext}
Grundlagen des \ZSFkeyword[Magnetfeld]{Magnetfelds}: magnetische Kräfte auf bewegte Ladungen und Ströme, die Erzeugung von \ZSFkeyword[Magnetfeld]{B-Feldern} durch Leiter (\ZSFkeyword{Biot-Savart}, \ZSFkeyword{Ampère}) sowie magnetische Eigenschaften der Materie. Zentral für Aufgaben zur Teilchenablenkung und Felderzeugung.
\end{runintext}
\begin{runintext}
...
\ZSFindex{Magnetisierung}
\ZSFindex[Magnetische Suszeptibilitat]{Magnetische Suszeptibilität}
\begin{runintext}
Wie verschiedene Materialien (\ZSFkeyword[Paramagnetismus]{Para-}, \ZSFkeyword[Ferromagnetismus]{Ferro-}, \ZSFkeyword[Diamagnetismus]{Diamagnete}) externes Magnetfeld verstärken oder schwächen.
\end{runintext}
\begin{runintext}
...
\end{formulabox}
\begin{runintext}
\ZSFkeyword[Paramagnetismus]{Paramagnetisch}: $\chi_{\mathrm{mag}}>0$ (leicht feldverstärkend, T-abhängig). \ZSFkeyword[Diamagnetismus]{Diamagnetisch}: $\chi_{\mathrm{mag}}<0$ (leicht feldschwächend, Supraleiter $-1$). \ZSFkeyword[Ferromagnetismus]{Ferromagnetisch}: sehr starke Verstärkung, \ZSFkeyword{Hysterese}, Weiss'sche Bezirke (kann permanent magnetisiert werden).
\end{runintext}
