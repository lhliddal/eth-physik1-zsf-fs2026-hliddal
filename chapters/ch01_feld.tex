...
\begin{runintext}
Formeln zu Kräften und Feldern von Punktladungen und Ladungsverteilungen: \ZSFkeyword{Coulomb-Kraft}, elektrisches Feld einzelner und vieler Ladungen, \ZSFkeyword[Dipol]{Dipole}, Feldlinien, Fluss und \ZSFkeyword{Gauss-Gesetz}. Nützlich bei Aufgaben mit Ladungen, Feldverläufen, Fluss und Symmetrie-Gauss-Flächen.
\end{runintext}

\SubsectionBar[sec:coulomb-charge]{Ladung, Coulomb}
\ZSFindex{Coulomb'sches Gesetz}
\begin{runintext}
Formeln für Ladungsmengen und die Kraft zwischen zwei \ZSFkeyword[Punktladung]{Punktladungen}; brauchst du, wenn in Aufgaben einzelne Ladungen und ihre Wechselwirkung im Abstand $r$ vorkommen.
\end{runintext}
\begin{defbox}[Elementarladung]
\ZSFkeyword[Ladungsquantisierung]{Quantisierung}: Ladung in Vielfachen von $e$. Elektron: $-e$, Proton: $+e$.
\end{defbox}
\begin{formulabox}
...
\begin{runintext}
Formeln für \ZSFkeyword{Dipolmoment}, \ZSFkeyword{Drehmoment} und Energie eines Dipols im Feld; brauchst du bei Aufgaben zu polaren Molekülen oder kleinen Ladungspaaren im homogenen \ZSFkeyword[Elektrisches Feld]{elektrischen Feld}. \ZSFkeyword{Dipol}: zwei entgegengesetzt gleiche Ladungen, Abstand $\vec{\ell}$ (von $-$ nach $+$).
\end{runintext}
...
\begin{runintext}
Formel, um das \ZSFkeyword[Elektrisches Feld]{elektrische Feld} \ZSFkeyword[Ladungsverteilung]{kontinuierlicher Ladungsverteilungen} (Volumen-, Flächen- oder Linienladungen) über ein Integral zu berechnen; nützlich bei ausgedehnten Ladungswolken, Drähten oder Flächen.
\end{runintext}
\begin{formulabox}
...
\begin{runintext}
Formel für den \ZSFkeyword[Elektrischer Fluss]{elektrischen Fluss} durch eine Fläche; brauchst du, wenn in Aufgaben Feldlinienanzahl oder Fluss durch eine gegebene Fläche vorkommt und als Vorbereitung für das \ZSFkeyword{Gauss-Gesetz}.
\end{runintext}
\begin{formulabox}
...
\begin{runintext}
Integralform des \ZSFkeyword[Gauss-Gesetz]{Gauss-Gesetzes} und Randwerte am Leiter; nützlich zur Bestimmung von \ZSFkeyword[Elektrisches Feld]{elektrischen Feldern} stark symmetrischer Ladungsverteilungen ohne explizite Integration.
\end{runintext}
\begin{formulabox}
...
\begin{runintext}
Fertige Resultate für \ZSFkeyword[Elektrisches Feld]{elektrische Felder} typischer Symmetrien (Linienladung, Ring, Scheibe, Ebene, Kugel); praktisch zum schnellen Einsetzen in Zahlenaufgaben mit diesen \ZSFkeyword*{Standardgeometrien}.
\end{runintext}
\begin{formulabox}
\[
\begin{gathered}
