...
\begin{runintext}
Analyse von Stromkreisen bei \ZSFkeyword[Wechselspannung]{sinusförmigen Spannungen}. Wichtige Konzepte umfassen \ZSFkeyword[Effektivwert]{Effektivwerte}, Blind- und Scheinwiderstände (\ZSFkeyword{Impedanz}) bei Spulen und Kondensatoren, sowie Leistung und oszillierende \ZSFkeyword[LC-Netzwerk]{LC-Netzwerke}.
\end{runintext}
...
\formulanote{Zweck: Induktiver Blindwiderstand $X_L$ einer Spule (Spannung eilt Strom um 90° voraus).}
\end{formulabox}

\begin{formulabox}
\[ X_C = \frac{1}{\omega C} \quad \implies \quad I_{\mathrm{eff}} = \frac{U_{C,\mathrm{eff}}}{X_C} \]
\formulanote{Zweck: Kapazitiver Blindwiderstand $X_C$ eines Kondensators (Strom eilt Spannung um 90° voraus).}
\end{formulabox}
\begin{factlist}
