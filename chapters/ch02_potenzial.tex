...
\begin{runintext}
Formeln, wie sich \ZSFkeyword{Potenzialdifferenzen} aus dem \ZSFkeyword{elektrischen Feld} ergeben und welche Einheiten zu \ZSFkeyword{Volt} gehören; nützlich, wenn Spannungen aus Feldern oder verrichteter Arbeit bestimmt werden.
\end{runintext}
...
\begin{runintext}
\textbf{Dünne Kugelschale} (Radius $R$, Ladung $Q$): Im Inneren ist das \ZSFkeyword{elektrische Feld} null (Faraday-Käfig) und das Potenzial ortsunabhängig konstant. Aussen wirkt die Schale wie eine Punktladung im Zentrum.
\end{runintext}
\begin{formulabox}
\[
...
\begin{runintext}
Zusammenhang zwischen Potenzial und Feld über Ableitungen bzw.\ den \ZSFkeyword{Gradienten}; nützlich, um aus einem gegebenen Potenzial das \ZSFkeyword{elektrische Feld} oder aus dem Feld die Potenzialänderung zu bestimmen.
\end{runintext}
\begin{runintext}
